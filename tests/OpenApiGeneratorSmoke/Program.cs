...
""";
    ...
    foreach (var expected in new[] { "Public JsonParse As String", "Public Json_parse As Long", "Public Function ApiSetHeader(", "Public Sub ApiSetApi_Token(", "Public Sub ApiSetApi_Token2(" })
