...
- [x] evaluator/parser-specific failures map to XPScript error 5 with Evaluate context across undeclared assignment, duplicate declaration, unsupported local type, malformed syntax/tokenization and callvar indexing/arity/rank paths; runtime source: `samples/evaluate-parser-error-mapping.xps`
