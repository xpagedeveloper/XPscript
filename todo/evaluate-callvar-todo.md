...
- [x] XPScript and CLR array element counts are checked before allocating snapshot arrays; exact 100000/100001 boundaries are verified by `samples/evaluate-collection-element-boundary.xps` and `tests/EvaluateClrArrayBudgetProbe`, including a CLR array with a non-zero lower bound
