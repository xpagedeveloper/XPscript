...
- [x] Build on Windows, Ubuntu and macOS.
- [x] Run managed/native dependency staging regressions on Windows, Ubuntu and macOS.
- [x] Mark the corresponding security-review TODO complete after the verification gate passes.
