...
This index maps the language/runtime documentation to the existing source fixtures under `samples/`. The documentation uses the samples as its source examples instead of inventing separate example programs.

## Core language

See `docs/core-language.md`.
...
See `docs/arrays-lists-operators.md`.
...
See `docs/types-classes-modules.md`.
...
See `docs/strings-conversion-base64.md`.
...
See `docs/file-io-filesystem.md` and `docs/text-io-console.md`.
...
- file portions of `samples/core-language.xps`
...
See `docs/console-process-formatting.md`.

Covered samples:

- `samples/textio-console.xps`
- `samples/platform-shell.xps`
- standalone runtime-function portions of `samples/runtime-sax.xps`
- `samples/file-io-extensions.xps`
...
- `samples/evaluate-xpscript.xps`
- `samples/evaluate-callvar.xps`
- `samples/evaluate-array-helpers.xps`
- `samples/evaluate-standard-functions.xps`
- `samples/evaluate-nested-collections.xps`
- `samples/evaluate-no-return.xps`
- `samples/evaluate-callvar-readonly-error.xps`
- `samples/evaluate-scope-error.xps`
- `samples/evaluate-coercion-diagnostics.xps`
- `samples/evaluate-function-arity-errors.xps`
- `samples/evaluate-collection-element-budget.xps`
- `samples/evaluate-collection-payload-budget.xps`
...
- `samples/compatibility.xps`
- `samples/json-http.xps`
- `samples/runtime-sax.xps`
