...
internal static class NotesViewNavigatorCachePostProcessor
{
    public static string Apply(string source)
    {
        ...
        source = ReplaceRequired(
            ...
            "    private int _cacheSize = 128;\n    private int _maxLevel = int.MaxValue;\n    private bool _streaming;\n    private bool _streamExhausted;\n    public int CacheSize { get { EnsureAlive(); return _cacheSize; } set { EnsureAlive(); _cacheSize = Math.Clamp(value, 0, 128); } }",
    ...
    private bool EnsureRowsThrough(int index)
    {
        ...
        if (!_streaming || _streamExhausted) return false;
...
""";
    ...
    {
        EnsureInitialized();
        requested = Math.Clamp(requested, 1, 128);
