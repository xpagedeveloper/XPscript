...
public static class CompilerDiagnosticCatalog
{
    private static readonly IReadOnlyDictionary<string, CompilerDiagnosticDefinition> Definitions =
        new[]
        {
            ...
            Define("XPS1008", "syntax", "A native constructor is missing a required argument.", "symbol", "symbolKind", "expectedArgument"),
            ...
            Define("XPS1012", "syntax", "Invalid XPScript syntax.", "foundToken", "expectedConstruct"),
