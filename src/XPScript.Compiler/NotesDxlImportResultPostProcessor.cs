...
internal static class NotesDxlImportResultPostProcessor
{
    public static string ApplyBuiltSurface(string source)
    {
        ...
        // Keep these declarations inside XPScriptNotesNativeApi, but anchor them to
        // the importer method rather than to another delegate declaration. The
        // runtime builder can normalize/rewrite native delegate declarations before
        // this postprocessor runs, while CreateDxlImporter is a stable API anchor.
        source = InsertBeforeRequired(source,
...
""";
    ...
    private static string InsertBeforeRequired(string source, string anchor, string value, string stage)
    {
