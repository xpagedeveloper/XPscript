...
""");
        ...
        // Serialize accessibility metadata to desktop/browser desktop bridge requests.
        generated = ReplaceRequired(generated,
        ...
        // Expose announcement state internally to the bridge serializer.
        generated = ReplaceRequired(generated,
            "    public bool HasValidationErrors => _fields.Any(field => field.ValidationError.Length > 0);",
            """    public bool HasValidationErrors => _fields.Any(field => field.ValidationError.Length > 0);
    ...
    internal string AccessibilityAnnouncementPriority => _announcementPriority;""");
        ...
        // Desktop focus and announcement reflection bridge.
        generated = ReplaceRequired(generated,
    ...
    {""");
        ...
        // Browser HTML accessibility attributes. Existing native labels stay authoritative by default.
        generated = ReplaceRequired(generated,
    ...
    {""");
        ...
        // Add hidden help descriptions just before field error output.
        generated = ReplaceRequired(generated,
            "            if (field.ValidationError.Length > 0)\n                html.Append(\"<div class=\\\"xpscript-uiform-error",
