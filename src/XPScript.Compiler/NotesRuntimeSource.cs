...
internal static class NotesRuntimeSource
{
    ...
    internal const string MailFeatureMarker = "// XPSCRIPT_NOTES_MAIL_FEATURE";
    ...
    public static string Build(NotesRuntimeFeatures features)
    {
        ...
        source = NotesDatabaseAccessPostProcessor.Apply(source);
        ...
        source = NotesDocumentSendPostProcessor.Apply(source);
